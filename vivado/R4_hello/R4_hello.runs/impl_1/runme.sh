...
HD_PWD='C:/Users/takas/src/R4/vivado/R4_hello/R4_hello.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log R4_hello_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source R4_hello_top.tcl -notrace
