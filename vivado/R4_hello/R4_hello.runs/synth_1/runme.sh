...
HD_PWD='C:/Users/takas/src/R4/vivado/R4_hello/R4_hello.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log R4_hello_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source R4_hello_top.tcl
