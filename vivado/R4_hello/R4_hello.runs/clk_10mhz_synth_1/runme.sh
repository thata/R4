...
HD_PWD='C:/Users/takas/src/R4/vivado/R4_hello/R4_hello.runs/clk_10mhz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_10mhz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_10mhz.tcl
